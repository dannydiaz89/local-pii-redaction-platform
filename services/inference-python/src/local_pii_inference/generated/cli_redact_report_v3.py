...
#   filename:  redact-report-v3.schema.json
...
class WriterReceipt(RootModel[WriterReceiptSummary]):
    root: WriterReceiptSummary
...
class Output(RootModel[ArtifactSummary]):
...
class Input(RootModel[ArtifactSummary]):
    root: ArtifactSummary


class Verification(RootModel[VerificationAttestationV2]):
    root: VerificationAttestationV2


class PolicyBoundCLIRedactionReportV3(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
