...
export const errorCodes = [
  ...
  'ARTIFACT_DIGEST_MISMATCH', 'STORAGE_UNAVAILABLE', 'JOB_CONFLICT', 'OUTPUT_COLLISION', 'RATE_LIMITED',
  'SUPPLY_CHAIN_INVALID', 'AUTHORIZATION_DENIED', 'OPERATION_CANCELLED', 'INTERNAL_ERROR'
] as const;
