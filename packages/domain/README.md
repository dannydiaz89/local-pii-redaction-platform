...
- Defines append-only typed native locations and canonical regions for JSON values, CSV cells,
  DOCX paragraphs, stable relationship targets, and bounded value-free XML carriers.
