...
Filesystem and process-local sessions share the same native parser/writer/reopen semantics. The process-local session selects no path and zeroes its owned staged or published buffers on disposal.
