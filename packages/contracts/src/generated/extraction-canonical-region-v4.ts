...
/**
 * One canonical Unicode code-point region and its exact value-free native location, including bounded PDF metadata.
 */
export interface CanonicalStructuredRegionV4 {
  schemaVersion: '4.0.0';
  start: number;
  end: number;
  offsetUnit: 'UNICODE_CODE_POINT';
  role: 'VALUE';
  location: NativeStructuredLocationV4;
}
