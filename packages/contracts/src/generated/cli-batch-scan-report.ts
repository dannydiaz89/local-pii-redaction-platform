...
/**
 * Privacy-safe aggregate manifest for one bounded recursive rules-only scan attempt. Paths, names, content digests, values, native locations, and patterns are excluded.
 */
export type BoundedBatchScanReport = {
  [k: string]: unknown;
} & {
  schemaVersion: '1.0.0';
