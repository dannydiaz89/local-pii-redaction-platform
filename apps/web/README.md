...
rendered. The application does not yet provide durable resume, editable review decisions,
redaction, or download. Running Vite directly intentionally shows the disconnected state
