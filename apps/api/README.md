...
- Runs an authenticated 8 MiB process-local TXT/Markdown preview scan that returns only counts.
...
upload, asynchronous processing, review, report, download, or durable-storage routes. The external-browser handoff also does not protect against an
